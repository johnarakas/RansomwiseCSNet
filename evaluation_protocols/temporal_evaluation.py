...
from evaluation_protocols.eval_protocols import temp_split
...
if __name__ == '__main__':
	...
	accumulated_rolling_cv = False

	fname_suffix = 'accum' if accumulated_rolling_cv else 'non_accum'
	...
	for years_per_fold_num in train_years_per_fold:
		...
		for curr_train_ids, curr_test_ids in zip(train_win_ids, test_win_ids):
			...
			curr_train_ids = [*accumulated_ids, *curr_train_ids]

			if accumulated_rolling_cv:
				accumulated_ids = curr_train_ids.copy()
